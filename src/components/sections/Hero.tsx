  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Heading */}
        <h1 className="poppins-black text-3xl sm:text-4xl md:text-6xl lg:text-7xl 
        ...
        {/* Description */}
        <p className="poppins-light text-white/70 text-sm md:text-base sm:text-lg mb-10 max-w-xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto text-sm md:text-base">
          <button
            ...
            className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-red-700 to-red-900 
                       rounded-full text-white poppins-semibold shadow-xl hover:scale-105 transition"
          >
            Start Your Project
          </button>
          ...
          <button
            ...
            className="px-6 sm:px-8 py-3 sm:py-4 border border-white/30 rounded-full 
                       text-white poppins-medium hover:bg-white/10 transition"
          >
            View Work
          </button>
        </div>

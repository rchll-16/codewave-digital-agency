      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-10 md:px-16 lg:px-24">
          ...
          <div className="text-center mb-14 sm:mb-16 md:mb-20">
            ...
            <p className="poppins-light text-sm sm:text-base text-gray-600 max-w-xl mx-auto leading-relaxed">
            ...
            {team.map((member, index) => (
              <div
                ...
                className="group bg-white/80 backdrop-blur-md p-6 sm:p-8 rounded-2xl sm:rounded-3xl border border-gray-100 
                     shadow-md hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 text-center"
              >
                {/* Avatar */}
                ...
                {/* Divider */}
                <div className="w-8 sm:w-10 h-1 bg-red-500 mx-auto mt-4 rounded-full opacity-60 group-hover:w-16 transition-all duration-300"/>
              </div>
            ))}
          </div>
        </div>

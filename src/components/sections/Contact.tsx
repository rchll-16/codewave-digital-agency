  ...
  return (
    <div>
      ...
      >
        ...
        {/* Background Glow */}
        <div className="absolute -top-40 -left-40 w-72 sm:w-96 h-72 sm:h-96 bg-red-800/20 blur-[120px] rounded-full animate-hero-bg"/>
        <div className="absolute -bottom-40 -right-40 w-72 sm:w-96 h-72 sm:h-96 bg-red-600/20 blur-[120px] rounded-full animate-hero-bg"/>

        <div className="relative max-w-4xl mx-auto text-center">

          {/* Availability Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1 mb-6 text-xs sm:text-sm 
                    bg-white/10 backdrop-blur-md rounded-full border border-white/20 animate-fade-up">
            <span className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></span>
            <span className="poppins-regular text-white/80">Currently accepting new projects</span>
          </div>

          {/* Headline */}
          <h2 className="poppins-bold text-3xl sm:text-4xl md:text-5xl leading-tight mb-6 animate-fade-up [animation-delay:0.1s]">
            Let’s Build Something <span className="text-red-500">Exceptional</span>
          </h2>

          {/* Subtext */}
          <p className="poppins-light text-white/70 max-w-2xl mx-auto mb-10 sm:mb-12 text-sm sm:text-base md:text-lg animate-fade-up [animation-delay:0.2s]">
          ...
          <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl sm:rounded-3xl 
                    p-6 sm:p-8 md:p-10 shadow-2xl animate-scale [animation-delay:0.3s]">
            <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-6 md:gap-8">
              ...
              <button
                ...
                className="relative w-full md:w-auto px-8 sm:px-10 py-3 sm:py-4 bg-gradient-to-r from-red-700 to-red-900 
                     ...
                     hover:scale-105 hover:shadow-red-900/50 animate-scale [animation-delay:0.45s]"
              >
                Start Your Project
              </button>
            </div>
          ...
          <div className="mt-10 sm:mt-12 text-white/50 text-xs sm:text-sm poppins-regular space-y-2 animate-fade-up [animation-delay:0.55s]">

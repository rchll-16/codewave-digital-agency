...
const Footer = () => {
  return (
    <footer className="relative bg-black text-white overflow-hidden border-t border-white/10">
      {/* Background Glow */}
      <div className="absolute -bottom-40 -left-40 w-125 h-125 bg-red-800/20 blur-[150px]" />
      <div className="absolute -top-40 -right-40 w-125 h-125 bg-red-600/20 blur-[150px]" />

      <div className="relative max-w-7xl mx-auto px-8 lg:px-24 pt-10 pb-10">
        <div className="grid md:grid-cols-4 gap-14">
          ...
          {/* Services */}
          <div>
            <h4 className="poppins-semibold mb-6 text-red-500 tracking-wide">Services</h4>
          ...
          {/* Company */}
          <div>
            <h4 className="poppins-semibold mb-6 text-red-500 tracking-wide">Company</h4>
            <ul className="space-y-3 text-sm text-white/60 poppins-regular">
          ...
          {/* Contact */}
          <div className="space-y-5">
            <h4 className="poppins-semibold text-red-500 tracking-wide">Contact</h4>
        ...
        {/* Divider */}
        <div className="border-t border-white/10 mt-10 pt-6 text-center text-sm text-white/40 poppins-regular">
